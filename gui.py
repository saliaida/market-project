...
def close():
    c = messagebox.askquestion('هشدار' , 'برای خروج اطمینان دارید ؟')
    if c == 'yes':
        win.destroy()
...
#نام کالا
name_label = Label(win , text = 'نام کالا : ' , font= 'kamran' , bg ='#e84343' , fg='black')
...
#قیمت خرید
buy_label = Label(win , text='قیمت خرید : ' , font='kamran' , bg ='#e84343' , fg='black')
...
#قیمت فروش
sale_label = Label(win , text='قیمت فروش : ' , font='kamran' , bg ='#e84343' , fg='black')
...
#تعداد
num_label = Label(win , text= 'تعداد : ' , font='kamran' , bg ='#e84343' , fg='black')
